...
def main():
    saved_model_path='/nas/home/lcomanducci/xai_src_loc/endtoend_src_loc2/models/samplecnn/model'+'_SNR_'+str(SNR)+'_T60_'+str(T60)+'.pth'
    model = network_lib.SampleCNNLoc()
    ...
    log_name = os.path.join(args.log_dir, 'SampleCNN_SNR_'+str(SNR)+'_T60_'+str(T60)+'_'+ datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
